const music = new Audio("audio/18.mp3");
//music.play();
...
const songs = [
    ...
    },
    {
        ...
        <div class="subtitle">Atif Aslam & Nushrat Bharucha</div>`,
        poster: "11.jpg"
    },
    {
        id: 12,
    ...
    {
        id: 14,
        songName: `Mera Pehla Junoon<br>
        <div class="subtitle">Jubin N|Neeti M</div>`,
        poster: "14.jpg"
    },
    {
        id: 15,
...
Array.from(document.getElementsByClassName("playListPlay")).forEach((e) =>{
    e.addEventListener("click", (el)=>{
        ...
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
        download_music = songs.href = `audio/${index}.mp3`
